 ...
 *  03/22/2014
 Paged used for adding a group to an existing teacher using
 the teachers coodinator code.
 *******************************************************************--%>
...
<fieldset>
<h3>Admininstration - Add To Existing Group</h3>
</fieldset>
...
<!--START FORM-->
<form id="newGroupForm" method="post" action="http://localhost:8080/RealityUWeb/AddGroupServlet" onSubmit="return validate(this);">
...
<%		x5++;
	...
	<div>
		<label for="coordinatorCode">Add To Group With Coordinator Access Code:</label>
		<input type="text" name="coordinatorCode" value="">
	</div>
	</select>
