<%--*******************************************************************
 *	RealityUWeb: CoordinatorOpenGroup.jsp
 *	Created by Josh
 *  10/5/2014
 *  04/14/2014
 
 Same page as opengroup just removed the admin controls 
 *******************************************************************--%>
...
String username = (String)ses1.getAttribute("userID");
//String code = cr.getUsername();
System.out.println("Finding this code"+ username);
lstGroups = gd.findCoordinatorGroups(username);
...
<title>Communities In Schools - Reality U Coordinator Open Group</title>
<meta charset="utf-8">
...
<!--START FORM-->
<form id="newGroupForm" method="post" action="http://localhost:8080/RealityUWeb/CoordinatorGroupServlet">
<fieldset>
<br><br>
		<div class="sameLine">
...
<!--SUBMIT FORM BUTTONS-->
		<div class="sameLine leftPadding">
			<input type="submit" value="Open Group" name="CoordinatorOpenGroup" id="submit">
			<a href = "http://localhost:8080/RealityUWeb/CreateRoster.jsp"> <input type="button" value="Create Roster" name="openRoster" id="submit"></a>
...
<fieldset>
  ...
  <table id="openGroupTable">
	...
	<!--START FORM-->
	<form id="newGroupForm" method="post" action="http://localhost:8080/RealityUWeb/CoordinatorGroupServlet" onSubmit="return validate(this);">
...
%>	
	...
	<input type="hidden" name="pageID" value="CoordinatorOpenGroup">
		...
		<div id="formButtonsContainer">
		  ...
		  if((info.equals("Male") || (info.equals("Female")))){ %>
            ...
            if (isProcessed != null || (!(lstSurveys.get(i).getJob().equals("")) && lstSurveys.get(i).getJob() != null)) {               
               	...
               	%>
               	<a href = "http://localhost:8080/RealityUWeb/CoordinatorViewSurveyProcess.jsp">
               	<% 
               	out.println("<input type='button' value='Processed' name='processed' id='processed' onclick='btn=\"Processed\";'>"); 
           	} //end if
			}%>
				</a>
