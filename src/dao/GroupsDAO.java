...
//==========================Josh's MarriageChoice===========================================
	//Method to find out if the group is a "yes" or "no" for the marriage option
	...
	//Selects all the groups that have the same coordinator id so that when the coordinator logs in they will
	// have a list of classes based on their Coordinator userID
	...
	// Used for displaying all groups at once for the admin but also its in ASC order for the coordinatorList fuction.
	...
	//Simple method to get a groups name based on id.
	...
	//Simple method to get the Teachers name based on the groups id.
	...
	//Simple method to get the class period based on GroupID.
	public String cpName(String name) {
		//Check Table & Create Table if it doesn't already exist
		boolean success = createTable();
		System.out.println("Check if table exists (create if doesn't exist). Table exists: " + success);
	...
	// Simple method to get the event date based on the groups id.
	public String eventdate(String name) {
		//Check Table & Create Table if it doesn't already exist
		boolean success = createTable();
		System.out.println("Check if table exists (create if doesn't exist). Table exists: " + success);
	...
	//Simple method to get the schools name based on the GroupsID.
	public String schoolName(String name) {
		...
		try {
			...
			// Create SQL Statement
			strWhere = "WHERE studentAccessCode = '" + name+"'";
	...
	//Simple method to get the groups name based on studentAccessCode.
	public String gname(String name) {
		//Check Table & Create Table if it doesn't already exist
		boolean success = createTable();
		System.out.println("Check if table exists (create if doesn't exist). Table exists: " + success);
	...
	//Simple method to get the groupsID based on the studentAccessCode.
	...
	public ArrayList<String> findExpiredDates() {
		//Check Table & Create Table if it doesn't already exist
		boolean success = createTable();
		System.out.println("Check if table exists (create if doesn't exist). Table exists: " + success);
		...
		ArrayList<String> lstGroup = new ArrayList<String>();
		...
		try {
			...
			while (rs.next()) {
				...
				String sed=rs.getString("surveyEndDate");
				String hs=rs.getString("highschool");
				String tch=rs.getString("teacher");
				String cp=rs.getString("classPeriod");
	...
	public void delete(String grp) {
		...
		try {
			...
			// Create SQL Statement
			String sql = "DELETE FROM Group_ WHERE id = "+grp+"";
			stmt = conn.prepareStatement(sql);
			System.out.println("SQL: " + sql);
