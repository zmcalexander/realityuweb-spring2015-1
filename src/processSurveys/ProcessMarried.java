...
public class ProcessMarried {
	...
	public List<Survey> doProcess(List<Survey> surveysList) {
		...
		<!--         Created by Josh                -->
		<!--========================================  */
		// Gets the groups id and searches if the marriage choice is a "yes" or "no"
		// and decides the percents of the marriedRequirementRatio and divorcedRequirementRatio.
